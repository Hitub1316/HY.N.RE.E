"""
test3.py — Smoke test: contextual enrichment on a small batch (5-10 chunks).
"""
...
from src.contextual_enrichment import enrich_chunk
...
for c in test_chunks:
    result = enrich_chunk(c)
    preamble = result.get("preamble", result)
